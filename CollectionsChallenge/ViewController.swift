...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var myFavoriteMovies: [String] = ["venom","aquaman","moana"]
    var myMovieRatings = ["venom": 5,"aquaman": 4,"moana": 3]
    ...
    @IBAction func whenStretch1ButtonPressed(_ sender: UIButton) {
        ...
        myFavoriteMovies.append("antman")
        myMovieRatings["antman"] = 4
    ...
    @IBAction func whenStretch2ButtonPressed(_ sender: UIButton) {
        ...
        myFavoriteMovies.append("spiderman")
        myFavoriteMovies [0] = "spiderman"
        myMovieRatings["spiderman"] = 3
